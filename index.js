...
var token ='446084495:AAEjUw_FD9J9945KB2t5L2JImyP2clWZxHc';
var api = new telegramBot(token, {polling: true});
api.onText(/\/help/, function(msg, match) {
var fromId = msg.from.id;
api.sendMessage(msg.from.id, "I can help you in getting the sentiments of any text you send to me.");
});
api.onText(/\/start/, function(msg, match) {
var fromId = msg.from.id;
api.sendMessage(fromId, "They call me AbhineetFirstTelegramBot. " +
...
console.log("AbhineetFirstTelegramBot has started. Start conversations in your Telegram.");
